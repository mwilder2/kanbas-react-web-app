  ...
  return (
    <div id="wd-css-styling-forms">
      ...
      <div id="wd-css-styling-switches">
        ...
        <div className="form-check form-switch">
          <input className="form-check-input" type="checkbox" id="switch2" defaultChecked />
      ...
      <div id="wd-css-responsive-forms-1">
        ...
        <div className="mb-3 row">
          ...
          <div className="col-sm-10">
            <input type="text" className="form-control" id="email1" defaultValue="email@example.com" />
          </div>
        </div>
        <div className="mb-3 row">
          ...
          <fieldset className="row mb-3">
            ...
            <div className="col-sm-10">
              <div className="form-check">
                <input className="form-check-input" type="radio" name="gridRadios" id="r3" defaultValue="option1" defaultChecked />
                <label className="form-check-label" htmlFor="r3">First radio</label>
              </div>
              <div className="form-check">
                <input className="form-check-input" type="radio" name="gridRadios" id="r4" defaultValue="option2" />
                <label className="form-check-label" htmlFor="r4">Second radio</label>
              </div>
              <div className="form-check disabled">
                <input className="form-check-input" type="radio" name="gridRadios" id="r5" defaultValue="option3" disabled />
